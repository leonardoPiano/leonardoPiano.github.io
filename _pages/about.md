...
- **Jailbreak Defense**  
  Designed lightweight, inference-time defenses to protect models from adversarial attacks *(presented at ECML-PKDD 2025)*.

- **Prompt Moderation**  
  Developed a novel span-based moderation dataset covering 20+ harm categories, aimed at improving the auditability of AI safety pipelines.
